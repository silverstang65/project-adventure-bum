...
const imageslevel0 = [
    ...
    {image: 'images/Level_0_alt 1.png', weight: 10},
    ...
    {image: 'images/chair1.png', weight: 10},
...
// protopyte Level exit logic (only works for level 0 door at the moment)
        if (selected.image === 'images/level0.png') {
            imgElement.style.cursor = 'pointer';
            imgElement.onclick = () => window.location.href = 'level1.html';
        } else {
